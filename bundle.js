...
function editNotification() {
  ...
  return { type: _const.RNS_EDIT_NOTIFICATION, opts: opts };
}
...
var RNS_EDIT_NOTIFICATION = exports.RNS_EDIT_NOTIFICATION = 'RNS_EDIT_NOTIFICATION';
...
function Notifications() {
  ...
  switch (action.type) {
    ...
    case _const.RNS_REMOVE_ALL_NOTIFICATIONS:
      return [];
    case _const.RNS_EDIT_NOTIFICATION:
      var opts = action.opts;

      var uid = opts.uid,
          parms = _objectWithoutProperties(opts, ['uid']);

      return state.map(function (notification) {
        return notification.uid !== uid ? notification : Object.assign({}, notification, parms);
      });
    default:
      return state;
  }
...
var Notifications = function (_React$Component) {
  ...
  function Notifications(props) {
    ...
    _this.notifications = []; //variable to keep refernce to all notifications, needs in case of update notification
    _this.editNotifications = _this.editNotifications.bind(_this);
  ...
  _createClass(Notifications, [{
    ...
    key: 'editNotifications',
    value: function () {
      function editNotifications(notifications) {
        var _this2 = this;

        notifications.map(function (notification, index) {
          _this2.system().editNotification(_this2.notifications[index], _extends({}, notification, {
            onRemove: function () {
              function onRemove() {
    ...
    value: function () {
      function addNotification(notifications) {
        ...
        this.notifications = notifications.map(function (notification) {
          return _this3.system().addNotification(_extends({}, notification, {
            onRemove: function () {
              function onRemove() {
                _this3.context.store.dispatch(actions.hide(notification.uid));
                notification.onRemove && notification.onRemove();
              }
          ...
          if (notifications.length > 0) {
            ...
            systemNotifications.forEach(function (notification) {
              if (notificationIds.indexOf(notification.uid) < 0) {
                _this4.system().removeNotification(notification.uid);
              }
            });
